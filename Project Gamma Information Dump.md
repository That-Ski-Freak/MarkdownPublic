...
Project Gamma is a card game for up to 8 players where you draft your deck and then play against your friends.

In games you will play units and attack your opponent to reduce their life to 0, but within this there is a lot of room for different strategies! The game is played in a dynamic shared round system, and seeks to reduce variance and non games to a minimum. You will seek to leverage hidden information, face down cards, and xyz to win the game.
...
- Claim - it's land etc etc. You {tap} your claims to pay for your cards. You may also use a claim to add 1 {mana} to your bank.
...
[morph card mockup]([https://docs.google.com/spreadsheets/d/1RDuqokq3RVDQv1vOBgSlnQbRpQ1KFyX1tBaPVvDhRUk/edit#gid=1942849584](https://media.discordapp.net/attachments/836870887214284850/1139241009646157834/Pasted_image_20230810080915.png))
## face down cards
...
### Starting the game:
To start the game, randomly determine the first player. Each player then shuffles their deck and draws 6 cards. Starting with the first player, each player may choose to keep their hand or shuffle it back into their deck and draw a new one. The first time you mulligan draw back to 6, second time draw back up to 5, then 4, etc. After both players keep their hands, put your starting claim into your hand, and begin the first turn of the game, priority starting with the first player. The first player will have priority first on odd rounds, and the second player will have priority first on even rounds.
...
Also gets rid of play/draw diff lol
